<%@ page language="C#" autoeventwireup="true" inherits="Login, App_Web_ab2xolxv" %>
    ...
    <script type="text/javascript">
        ...
        function LogMeIn() {
            ...
            if (data[0]) {
                ...
                location.href = "Config/SchoolHours.aspx";
            }
            else {
                ...
                <div class="col-md-12">
                    <div class="login-box" style="">
                        <div class="login-content">
                            ...
                            <img src="assets/images/School.png" height="100px" />
                            <!--</div>-->                            
                            <h3>
                                סגנית-ניהול שעות בית ספר </h3>
                        </div>
